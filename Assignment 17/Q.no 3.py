...
class MedicalStudent(Student):
    ...
    def Display(self):
        print(self)
    def __str__(self):
        return (f"MedicalStudent [ID:{self.sid},Name:{self.name},Age:{self.age},per:{self.percentage},specialization:{self.specialization},"
                f"Internship:{self.internship_mark},Rank:{self.CalculateRank}]")
    
m1 = MedicalStudent(101, "priya",22,72,"cardiology",85)
m1.Display()
